...
public:
    ...
    virtual void set_time_constrain(const time_t &time_constrain) override;
...
inline void boe_bot_command_base::set_time_constrain(const time_t &time_constrain) {
